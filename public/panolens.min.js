    ...
    function da(a, b) {
        ...
        this.update = function (a) {
            if (!1 !== c.enabled && c.deviceOrientation) {
                // Handle the updates based on device orientation
                startDeviceOrientationUpdates(a);
            }
        };
    
        function startDeviceOrientationUpdates(a) {
            ...
            } else if (180 == c.screenOrientation) {
                q = new d.Vector3(1, 0, 0);
                m.setFromAxisAngle(q, g);
            } else if (90 == c.screenOrientation) {
                q = new d.Vector3(0, 1, 0);
                m.setFromAxisAngle(q, g);
            } else if (-90 == c.screenOrientation) {
                q = new d.Vector3(0, 1, 0);
                m.setFromAxisAngle(q, -g);
